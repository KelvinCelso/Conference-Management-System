...
import { SubmittedState, UserBaseInfoState, UserCreateState, authorformStepState } from "@/lib/recoil";
...
const FirstStepForm = () => {
  ...
  const [submittedValues, setSubmittedValues] = useRecoilState(SubmittedState);
