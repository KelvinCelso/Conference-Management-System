          ...
          <ScrollArea className="h-[70vh] p-2">
            <div className="h-[60vh] space-y-2">
              <div className="space-y-2">
                <div className="flex">
                  <p className="font-bold text-sm">Topic Comment:</p>
                  <Textarea
                    disabled
              ...
              <div className="space-y-2">
                <div className="flex">
                  <p className="font-bold text-sm">contribution Comment:</p>
                  <Textarea
                    disabled
                    value={selectedPaper.assesmentData.contributionComment}
                  />
                </div>
                <div className="flex items-center justify-between space-x-2">
              ...
              <div className="space-y-2">
                <div className="flex">
                  <p className="font-bold text-sm">Academic Quality Comment:</p>
                  <Textarea
                    disabled
                    value={selectedPaper.assesmentData.academicQualityComment}
                  />
                </div>
                <div className="flex items-center justify-between space-x-2">
                  <p className="font-bold text-sm">Topic</p>
