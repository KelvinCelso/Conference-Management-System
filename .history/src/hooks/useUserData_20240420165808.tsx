...
const useUserData = (): UserDataProps => {
  ...
  const [inexistentUser, setInexistentUser] = useState<boolean>(false);
  useEffect(() => {
  ...
  return { userData, userDataLoading, userId, role, inexistentUser }; // Include userId in the returned object
};
